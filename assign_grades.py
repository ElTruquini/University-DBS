...
print("Opening assign_grades input file...\n")
with open(input_filename) as f:
	for row in csv.reader(f):
		...
		cursor.execute("Select insert_grades (%s, %s, %s, %s);", (course_code,term,student_id,grade))
		print(course_code,term,student_id,grade)
